...
const (
	...
	CartService_UpdateItem_FullMethodName = "/pb.CartService/UpdateItem"
...
type CartServiceClient interface {
	AddItem(ctx context.Context, in *AddItemRequest, opts ...grpc.CallOption) (*CartEmpty, error)
	UpdateItem(ctx context.Context, in *UpdateItemRequest, opts ...grpc.CallOption) (*CartEmpty, error)
...
func (c *cartServiceClient) AddItem(ctx context.Context, in *AddItemRequest, opts ...grpc.CallOption) (*CartEmpty, error) {
	out := new(CartEmpty)
...
func (c *cartServiceClient) UpdateItem(ctx context.Context, in *UpdateItemRequest, opts ...grpc.CallOption) (*CartEmpty, error) {
	out := new(CartEmpty)
	err := c.cc.Invoke(ctx, CartService_UpdateItem_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CartServiceServer interface {
	AddItem(context.Context, *AddItemRequest) (*CartEmpty, error)
	UpdateItem(context.Context, *UpdateItemRequest) (*CartEmpty, error)
...
func (UnimplementedCartServiceServer) AddItem(context.Context, *AddItemRequest) (*CartEmpty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddItem not implemented")
}
func (UnimplementedCartServiceServer) UpdateItem(context.Context, *UpdateItemRequest) (*CartEmpty, error) {
